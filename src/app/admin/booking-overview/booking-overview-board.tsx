                    ...
                    <div className="mb-2 flex flex-wrap items-center justify-between gap-2 border-l-4 border-brand-500 pl-3">
                      ...
                      {dKey >= todayKey && rows.some((r) => r.startTime > now) && (
                        <a
                          ...
                          className="inline-flex shrink-0 items-center gap-1.5 rounded-md bg-whatsapp px-2.5 py-1.5 text-xs font-semibold text-white shadow-sm hover:opacity-90 max-sm:min-h-[44px]"
                        >
