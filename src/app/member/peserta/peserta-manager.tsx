...
export default function PesertaManager({ items }: { items: PesertaItem[] }) {
  ...
  return (
    <div className="flex flex-col gap-6">
      {/* Kartu peserta aktif dan kartu "Tambah peserta" berbagi SATU grid
          (Hadi 18 Sep v3): di layar lebar keduanya sejajar, dan tiap kali
          peserta nambah, kartu tambah ikut ngalir ke jatah kolom
          berikutnya — turun ke baris bawah sendirinya, bukan dipatok di
          section terpisah. */}
      <section>
        <h2 className="mb-2 text-lg font-semibold text-text">Peserta</h2>
